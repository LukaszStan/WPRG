...
<body>
    ...
    ?>
    <h2>Artykuły technologiczne:</h2>
    <?php
    $conn = mysqli_connect("localhost","root","","portal_info");
    $zap1 = "SELECT artykulyID,tytul,uzytkownicy.login AS autor,tresc,data,obrazek,dzial FROM artykuly INNER JOIN uzytkownicy ON artykuly.uzytkownicy_uzytkownikID = uzytkownicy.uzytkownikID WHERE dzial = 'Technologia' ORDER BY data;";
